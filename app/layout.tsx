...
export const metadata: Metadata = {
  title: 'Memoist · transcript → document',
  description:
    'Wgraj transkrypcję spotkania projektowego i otrzymaj profesjonalne dokumenty: opis projektu, dokumentację B+R, kosztorys, harmonogram i więcej.',
  keywords: [
    'B+R',
    'badania i rozwój',
